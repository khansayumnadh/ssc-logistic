      ...
      <div class="card-stats">
        <div class="card-stats-items mt-3">
          <div class="card-stats-item">
            <div class="card-stats-item-count">{{ $total_adminssc }}</div>
            <div class="card-stats-item-label">Admin SSC</div>
          </div>
          <div class="card-stats-item">
            <div class="card-stats-item-count">{{ $total_adminlog }}</div>
            <div class="card-stats-item-label">Admin Logistic</div>
          </div>
          <div class="card-stats-item">
