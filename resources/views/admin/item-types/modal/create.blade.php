<!-- Modal -->
<div class="modal fade " id="item-types-create-modal" data-backdrop="static" tabindex="-1" role="dialog"
  aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Tambah Kategori Barang</h5>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="item-types-create-button">Tambah Kategori
                  Buku</button>
              </div>
            </div>
          </div>
